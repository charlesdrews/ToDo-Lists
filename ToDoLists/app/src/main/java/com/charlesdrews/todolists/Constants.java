...
public final class Constants {
    ...
    public static final String NEW_ITEM_TITLE = "NEW_ITEM_TITLE";
    public static final String NEW_ITEM_DETAIL = "NEW_ITEM_DETAIL";

    public static final String ORIGINAL_LIST_NAME = "ORIGINAL_LIST_NAME";
    public static final String ORIGINAL_ITEM_TITLE = "ORIGINAL_ITEM_TITLE";
